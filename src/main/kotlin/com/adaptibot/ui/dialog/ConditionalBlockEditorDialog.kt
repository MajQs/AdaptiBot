...
class ConditionalBlockEditorDialog(private val existingBlock: Step.ConditionalBlock? = null) : Dialog<Step.ConditionalBlock>() {
    ...
    init {
        title = if (existingBlock == null) "Add New IF/ELSE Block" else "Edit IF/ELSE Block"
        headerText = "Configure the conditional block properties"
        ...
        stepIdField.promptText = "unique-if-block-id"
        ...
        val infoLabel = Label("Note: Add THEN and ELSE steps after creation").apply {
