...
internal class WinApiHotkeyNativeApi(
    ...
    override fun registerHotKey(id: Int, modifierMask: Int, virtualKeyCode: Int): Boolean =
    ...
    override fun waitForNextHotkey(): Int? {
    ...
    override fun requestLoopExit(threadId: Int) {
